...
forge script script/0-KZA.s.sol --rpc-url $RPC_URL --broadcast --verify -vvvv
...
# deploy XKZA
forge script script/1-XKZA.s.sol --rpc-url $RPC_URL --broadcast --verify -vvvv
XKZA=($(jq -r '.transactions[0].contractAddress' broadcast/1-XKZA.s.sol/${chainId}/run-latest.json))
echo "XKZA=$XKZA" >> ".env"
# deploy vestingEscorow
forge script script/2-VestingEscrow.s.sol --rpc-url $RPC_URL --broadcast --verify -vvvv
...
# deploy minter
forge script script/3-Minter.s.sol --rpc-url $RPC_URL --broadcast --verify -vvvv
Minter=($(jq -r '.transactions[0].contractAddress' broadcast/3-Minter.s.sol/${chainId}/run-latest.json))
echo "Minter=$Minter" >> ".env"
# deploy VoteLogic
forge script script/4-VoteLogic.s.sol --rpc-url $RPC_URL --broadcast --verify -vvvv
...
forge script script/5-BribeAssetRegistry.s.sol --rpc-url $RPC_URL --broadcast --verify -vvvv
...
# deploy Voter
forge script script/6-Voter.s.sol --rpc-url $RPC_URL --broadcast --verify -vvvv
...
forge script script/7-KZADistributor.s.sol --rpc-url $RPC_URL --broadcast --verify -vvvv
...
forge script script/8-ReserveFeeDistributor.s.sol --rpc-url $RPC_URL --broadcast --verify -vvvv
...
# deploy RewardsVault
forge script script/9-RewardsVault.s.sol --rpc-url $RPC_URL --broadcast --verify -vvvv
...
forge script script/10-LockTransferStrategy.s.sol --rpc-url $RPC_URL --broadcast --verify -vvvv
...
forge script script/11-transferOwnershipGOV.s.sol --rpc-url $RPC_URL --broadcast --verify -vvvv
